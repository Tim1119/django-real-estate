    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Abuja', max_length=120, verbose_name='City')),
                ('postalcode', models.CharField(default='900109', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Agusi Inronsi Street, Maitaima', max_length=150, verbose_name='Street Adress')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.1, help_text='10% property tax charged', max_digits=6, verbose_name='Property Tax')),
                ('plot_area', models.DecimalField(decimal_places=2, default=0, max_digits=8, verbose_name='Plot Area(m^2)')),
                ('total_floors', models.IntegerField(default=0, verbose_name='Number of Floors')),
                ('bedrooms', models.IntegerField(default=1, verbose_name='Number of Beedrooms')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='agetbuyer', to=settings.AUTH_USER_MODEL, verbose_name='Agent, Seller or Buyer')),
            ],
            options={
